...
#FUNCION UTILITARIA PARA AGREGAR CANAL LUEGO DE OPERACION QUE DISMINUYA SUS DIM.
...
#Funciones usadas para la segmentacion
...
# tamano_ventana = Define el tamaño de l a vecindad alrededor de cada píxel para calcular su umbral.
